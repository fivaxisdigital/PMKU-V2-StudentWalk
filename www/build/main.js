...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__categories_categories__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__detail_category_detail_category__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__latest_latest__ = __webpack_require__(242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__favorite_favorite__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__about_about__ = __webpack_require__(68);
...
var HomePage = /** @class */ (function () {
    function HomePage(http, core, translate, navCtrl, InAppBrowser, platform, OneSignal, alertCtrl, config, storage, screenOrientation, modalCtrl) {
        ...
        this.CategoriesPage = __WEBPACK_IMPORTED_MODULE_11__categories_categories__["a" /* CategoriesPage */];
        this.DetailCategoryPage = __WEBPACK_IMPORTED_MODULE_12__detail_category_detail_category__["a" /* DetailCategoryPage */];
        this.LatestPage = __WEBPACK_IMPORTED_MODULE_13__latest_latest__["a" /* LatestPage */];
        this.FavoritePage = __WEBPACK_IMPORTED_MODULE_14__favorite_favorite__["a" /* FavoritePage */];
        this.AboutPage = __WEBPACK_IMPORTED_MODULE_15__about_about__["a" /* AboutPage */];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pipes_object_to_array_object_to_array__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_onesignal__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_in_app_browser__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__login_login__ = __webpack_require__(44);
        ...
        this.storageMul.get(['login', 'user']).then(function (val) {
            if (val) {
                ...
                if (val["login"] && val["login"]["token"]) {
                    ...
                    _this.isLogin = true;
                    _this.data['order'] = 0;
                    var params_1 = { post_num_page: 1, post_per_page: 1000, time: new Date().getTime() };
...
var PrivacyPage = /** @class */ (function () {
    ...
    PrivacyPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-privacy',template:/*ion-inline-start:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/pages/privacy/privacy.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{\'modern_privacy_policy_title\'|static}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n	<div  *ngIf="faded" class="faded-content" [ngClass]="{\'faded-has-content\':faded}" [innerHTML]="\'modern_description_privacy_policy\'|static"></div>\n</ion-content>\n<ion-footer ion-fixed><ion-toolbar><footer-tabs></footer-tabs></ion-toolbar></ion-footer>'/*ion-inline-end:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/pages/privacy/privacy.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__login_login__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__service_core_service__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__service_config_service__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pipes_object_to_array_object_to_array__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__address_address__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__login_login__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_in_app_browser__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_toast__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__service_config_service__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pipes_object_to_array_object_to_array__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__address_address__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_in_app_browser__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__service_config_service__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_native_toast__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_login_login__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__pipes_object_to_array_object_to_array__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pipes_object_to_array_object_to_array__ = __webpack_require__(43);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n<div absolute padding text-center width-100 primary-bg *ngIf="isLoaded && disconnect" class="disconnect">\n	{{\'general.disconnect\'|translate}}\n</div>'/*ion-inline-end:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/app/app.html"*/,
...
var ButtonCartComponent = /** @class */ (function () {
    ...
    ButtonCartComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'button-cart',template:/*ion-inline-start:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/components/button-cart/button-cart.html"*/' <button ion-button color="dark" icon-only clear (click)="gotoCart()" class="disable-hover">\n	<div>\n		<ion-badge item-right absolute>{{cart.count}}</ion-badge>\n		<ion-icon name="{{icon}}"></ion-icon>\n	</div>\n	<div text-left float-right class="info-cart">\n		<div>{{\'cart.totals\' | translate}}:</div>\n		<span >{{cart.total| price }}</span>\n	</div>\n</button>'/*ion-inline-end:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/components/button-cart/button-cart.html"*/
        }),
...
var HideShowComponent = /** @class */ (function () {
    ...
    HideShowComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'hide-show',template:/*ion-inline-start:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/components/hide-show/hide-show.html"*/'<button ion-button full no-margin (click)="change()" [color]="color" class="button-change">\n	<ng-content select="[this-title]"></ng-content>\n	<ion-icon [name]="show ? \'ios-arrow-up\' : \'ios-arrow-down\'"></ion-icon>\n</button>\n<div [hidden]="!show" padding-horizontal class="hide-show-content">\n	<ng-content select="[this-content]"></ng-content>\n</div>'/*ion-inline-end:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/components/hide-show/hide-show.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], HideShowComponent);
...
var ButtonQuantityComponent = /** @class */ (function () {
    ...
    ButtonQuantityComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'button-quantity',template:/*ion-inline-start:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/components/button-quantity/button-quantity.html"*/'<ion-row class="button-quantity-inner" wrap center>\n	<button no-margin ion-button clear [disabled]="innerValue<=min" (click)="minus()" class="disable-hover">-</button>\n	<input text-center class="value" #input no-margin [(ngModel)]="value" type="number" (blur)="inputBlur(true)" />\n	<button no-margin ion-button clear (click)="plus()" [disabled]="max<=innerValue" class="disable-hover">+</button>\n</ion-row>'/*ion-inline-end:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/components/button-quantity/button-quantity.html"*/,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_http__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__service_config_service__ = __webpack_require__(19);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_storage__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__module_ng2_translate__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_toast__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_storage__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_toast__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pipes_object_to_array_object_to_array__ = __webpack_require__(43);
...
var TermsPage = /** @class */ (function () {
    ...
    TermsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-terms',template:/*ion-inline-start:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/pages/terms/terms.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{\'modern_terms_ofuser_title\'|static}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n	<div *ngIf="faded" class="faded-content" [ngClass]="{\'faded-has-content\':faded}" [innerHTML]="\'modern_description_term_ofuse\'|static"></div>\n</ion-content>\n<ion-footer ion-fixed><ion-toolbar><footer-tabs></footer-tabs></ion-toolbar></ion-footer>'/*ion-inline-end:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/pages/terms/terms.html"*/,
        }),
        __metadata("design:paramtypes", [])
    ], TermsPage);
    return TermsPage;
...
var AboutPage = /** @class */ (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/pages/about/about.html"*/'<ion-header>\n	<ion-navbar>\n		<ion-title>{{\'modern_privacy_about_us\'|static}}</ion-title>\n		<ion-buttons end>\n			<button ion-button clear (click)="gotoContact()" class="disable-hover">\n				<span text-capitalize>{{\'about.contact\'|translate}}</span>\n			</button>\n		</ion-buttons>\n	</ion-navbar>\n</ion-header>\n\n<ion-content padding>\n	<div *ngIf="faded" class="faded-content" [ngClass]="{\'faded-has-content\':faded}" [innerHTML]="\'modern_description_about_us\'|static"></div>\n</ion-content>\n\n<ion-footer ion-fixed><ion-toolbar><footer-tabs></footer-tabs></ion-toolbar></ion-footer>'/*ion-inline-end:"/Volumes/Datnt/Work Team/modern shop 1.1.3/src/pages/about/about.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */]])
    ], AboutPage);
    return AboutPage;
